  ...
  return (
    <div className='flex flex-col bg-gray-200 dark:bg-gray-800 h-screen m-0 p-0'>
      ...
      <div className='xl:flex xl:justify-center bg-gray-300 dark:bg-gray-900 shadow-lg'>
        <div className='overflow-auto h-[calc(100vh-4.9rem)] xl:border-r xl:border-l xl:border-gray-400 dark:bg-gray-700 dark:border-gray-500 bg-white sm:w-full xl:w-300'>
