...
(7, 'cloze-click-test', 'Presente do indicativo:\nVerbos regulares em -ir', 'Aprende a conjugar os verbos regulares terminados em -ir no presente do indicativo. Pratica as formas mais usadas e ganha confiança para construir frases do dia a dia.');

INSERT INTO "Lesson"."Lessons" (id, type, level, title, description, image, state ) 
VALUES (22, 'grammar', 'A1', 'Presente do indicativo: Verbos regulares em -ir', 'Aprende a conjugar os verbos regulares terminados em -ir no presente do indicativo. Pratica as formas mais usadas e ganha confiança para construir frases do dia a dia.', '{portuguese.png}', 'P');
