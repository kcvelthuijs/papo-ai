...
CREATE FUNCTION "Cloze"."AddSentence"(p_sentenceset_id integer, p_sequence integer, p_textparts text[], p_translations jsonb, p_gaps jsonb) RETURNS jsonb
    LANGUAGE plpgsql
    AS $$
...
BEGIN
    ...
    RETURN jsonb_build_object(
        ...
        'sentenceSetId', p_sentenceSet_id,
        'sequence', p_sequence
    );
END;
$$;
...
CREATE FUNCTION "Cloze"."DeleteSentence"(p_sentence_set_id integer, p_sequence integer) RETURNS jsonb
    LANGUAGE plpgsql
    AS $$
...
BEGIN
    ...
    WHERE "sentenceSetId" = p_sentence_set_id
    ...
    IF v_sentence_id IS NULL THEN
        RETURN jsonb_build_object(
            ...
            'sentenceSetId', p_sentence_set_id,
            'sequence', p_sequence
        );
    END IF;
...
--
-- Name: SentenceSets; Type: TABLE; Schema: Cloze; Owner: -
--

CREATE TABLE "Cloze"."SentenceSets" (
    id integer NOT NULL,
    title character varying NOT NULL
);
...
--
-- Name: SentenceSets_id_seq; Type: SEQUENCE; Schema: Cloze; Owner: -
--

ALTER TABLE "Cloze"."SentenceSets" ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "Cloze"."SentenceSets_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE "Cloze"."Sentences" (
    ...
    "sentenceSetId" integer CONSTRAINT "Sentences_exerciseId_not_null" NOT NULL,
...
--
-- Name: SentenceSets SentenceSets_pkey; Type: CONSTRAINT; Schema: Cloze; Owner: -
--

ALTER TABLE ONLY "Cloze"."SentenceSets"
    ADD CONSTRAINT "SentenceSets_pkey" PRIMARY KEY (id);
...
ALTER TABLE ONLY "Cloze"."Sentences"
    ADD CONSTRAINT "UQ_Sentences_Exercise_Sequence" UNIQUE ("sentenceSetId", sequence);
...
--
-- Name: Exercises Exercises_sentenceSetId_fkey; Type: FK CONSTRAINT; Schema: Cloze; Owner: -
--

ALTER TABLE ONLY "Cloze"."Exercises"
    ADD CONSTRAINT "Exercises_sentenceSetId_fkey" FOREIGN KEY ("sentenceSetId") REFERENCES "Cloze"."SentenceSets"(id);
...
ALTER TABLE ONLY "Cloze"."Sentences"
    ADD CONSTRAINT "FK_Sentences_Exercises" FOREIGN KEY ("sentenceSetId") REFERENCES "Cloze"."Exercises"(id);
...
--
-- Name: Sentences Sentences_sentenceSetId_fkey; Type: FK CONSTRAINT; Schema: Cloze; Owner: -
--

ALTER TABLE ONLY "Cloze"."Sentences"
    ADD CONSTRAINT "Sentences_sentenceSetId_fkey" FOREIGN KEY ("sentenceSetId") REFERENCES "Cloze"."SentenceSets"(id);
